using TodoItemDDD.Application;
using TodoItemDDD.Application.Interface;
using TodoItemDDD.Domain.Interfaces.Repositories;

[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(TodoItemDDD.MVC.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(TodoItemDDD.MVC.App_Start.NinjectWebCommon), "Stop")]

namespace TodoItemDDD.MVC.App_Start
{
    using System;
    using System.Web;
